...
export LANG=C
export SOURCE_DATE_EPOCH=1530488860
...
R CMD check --no-manual --no-examples --no-codoc -l %{buildroot}/usr/lib64/R/library cobs|| : 
cp ~/.stash/* %{buildroot}/usr/lib64/R/library/*/libs/ || :
...
/usr/lib64/R/library/cobs/libs/symbols.rds
